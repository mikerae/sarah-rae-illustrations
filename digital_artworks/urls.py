...
urlpatterns = [
    ...
    path('<digital_artwork_id>', views.digital_artwork_detail, name='digital_artwork_detail'),
    path('add/', views.add_digital_artwork, name='add_digital_artwork'),
    path('edit/<int:digital_artwork_id>', views.edit_digital_artwork, name='edit_digital_artwork'),
